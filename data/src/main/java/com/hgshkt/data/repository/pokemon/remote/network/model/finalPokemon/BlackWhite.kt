...
data class BlackWhite(
    @SerializedName("animated") var animated: com.hgshkt.data.repository.pokemon.network.model.finalPokemon.Animated? = com.hgshkt.data.repository.pokemon.network.model.finalPokemon.Animated(),
